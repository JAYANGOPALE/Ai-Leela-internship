...
url_valid = "https://jsonplaceholder.typicode.com/users/5"
response = requests.get(url_valid)
datax = response.json() #save data in dict format 
print(f"URL: {url_valid}")
print(f"Status Code: {response.status_code}")
print(f"Success? {response.status_code == 200}")
print(f"phone: {datax['phone']}")
print(f"name: {datax['name']}")
...
for i, post in enumerate(posts[:5], 1):  # Show first 3
